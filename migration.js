...
db.serialize( () => {
        ...
        db.run("CREATE TABLE IF NOT EXISTS Timesheet (id INTEGER PRIMARY KEY NOT NULL, hours TEXT NOT NULL, rate TEXT NOT NULL, date INTEGER NOT NULL, employee_id INTEGER NOT NULL, FOREIGN KEY (employee_id) REFERENCES Employee(id) ); ");
